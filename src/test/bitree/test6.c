...
int main(int argc, char *argv[])
{
	...
	printf("[bitree - Test 6] Bitree None Recurse Traverse:\n") ;
	...
	/* @bitree_xxxorder_traverse_ex is non-recurse function. */
	printf("Bitree preorder traverse:\n");
	bitree_preorder_traverse_ex(root, show_elem);
	printf("\n");

	printf("Bitree inorder traverse:\n");
	bitree_inorder_traverse_ex(root, show_elem);
	printf("\n");

	printf("Bitree postorder traverse:\n");
	bitree_postorder_traverse_ex(root, show_elem);
	printf("\n");
